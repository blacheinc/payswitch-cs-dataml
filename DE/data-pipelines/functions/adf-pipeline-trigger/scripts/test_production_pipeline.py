...
Usage (from adf-pipeline-trigger directory): python scripts/test_production_pipeline.py --training-upload-id YOUR_UUID --data-source-id YOUR_UUID
...
Examples:
  ...
  python scripts/test_production_pipeline.py --training-upload-id abc-123 --data-source-id def-456
