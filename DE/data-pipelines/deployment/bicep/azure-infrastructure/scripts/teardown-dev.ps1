...
if (-not $Force) {
    Write-Warn "This permanently deletes the full dev environment (all listed resource groups)."
    $typed = Read-Host "Type DESTROY DEV to continue"
    if ($typed -ne "DESTROY DEV") {
